...
export default function Intro() {
        ...
        return (
            <section id="home" className="  mb-28 max-w-[50rem] text-center sm:mb-0 !scroll-mt-[100rem]">
                ...
                <a className=" bg-white text-gray-900 px-5 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-105 hover:scale-105 active:scale-105 transition cursor-pointer" target="_blank" rel="noopener noreferrer" href="https://alpha-x-demo.vercel.app/"> Alpha Algo <BsArrowRight/> </a>
